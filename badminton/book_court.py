...
class CourtBooking(object):
    ...
    def add_available_courts(self):
        ...
        print('form actino %s' % form_action)
        ...
        print("hidden_name hidden_valuez  %s, %s" % (hidden_name, hidden_value))
        ...
        try:
         print 'printing cusom headers %s' % self.custom_headers
         cart_response = self.client.post(form_action, headers=self.custom_headers, data=cart_data)
        except:
         traceback.print_exc()
    ...
    def checkout_cart(self):
        ...
        print 'printing custom headers %s' % self.custom_headers
